    ...
    const [
      ...
      prisma.revenue.aggregate({
        where: {
          ...
          deletedAt: null,
          status: 'RECEIVED',
          OR: [{ receivedAt: actualsBounds }, { receivedAt: null, date: actualsBounds }],
        },
      ...
      prisma.expense.aggregate({
        where: {
          ...
          deletedAt: null,
          status: 'PAID',
          OR: [{ paidAt: actualsBounds }, { paidAt: null, date: actualsBounds }],
        },
        _sum: { amount: true },
        _count: true,
      }),
      prisma.bill.aggregate({
        where: {
          ...
          deletedAt: null,
          status: 'PAID',
          OR: [{ paidAt: actualsBounds }, { paidAt: null, dueDate: actualsBounds }],
        },
        _sum: { amount: true },
        _count: true,
      }),
